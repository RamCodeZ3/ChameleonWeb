...
export default function Panel() {
  ...
  // Nombre de archivo "seguro" derivado del título de la página.
  ...
  function handleDownloadHtml() {
    ...
    downloadFile(html, 'text/html', `${getSafeFileName()}.html`);
  }
        ...
        <div className="overflow-y-auto flex-1">
          ...
          {state.selectedSelector && (
            <>
              ...
              {/* Acción sobre el elemento seleccionado */}
              <div className="px-3 pb-3">
                <button
                  onClick={handleResetSelector}
                  className="w-full flex items-center justify-center gap-1.5 bg-white/5 hover:bg-white/10 text-zinc-300 rounded-md px-2 py-1.5 text-xs font-medium transition-colors"
                >
                  <RotateCcw size={12} />
                  Reset elemento
                </button>
